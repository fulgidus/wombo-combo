...
describe("citty tasks command", () => {
  ...
  test("tasksCommand has all 9 subcommands defined (plus aliases)", async () => {
    ...
    // Also has aliases: ls, a, ss, sp, sd, ch, validate, ar, sh, g
    expect(subCommandNames.length).toBe(19);
  });
